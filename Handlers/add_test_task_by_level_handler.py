...
from Handlers.help_functions import look_at_added_test_task, handle_cancel_button, create_start_markup
...
def process_right_answer(
    ...
    try:
        ...
        bot.register_next_step_handler(
            message,
            process_look_at_added_test_task,
            task_id,
            topic,
            question,
            first_answer,
...
def process_look_at_added_test_task(
    message,
    task_id,
    topic,
    question,
    ...
    try:
        ...
        if message.text in ("Continue", "cancel"):
            ...
            bot.send_message(
                chat_id,
                f"{task_id}, {topic}, {question}, {first_answer}, {second_answer}, "
