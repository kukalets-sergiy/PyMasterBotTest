...
class TestAddAdminHandler(unittest.TestCase):
    def test_add_admin_function(self):
        ...
        # Mock the PyMasterBotDatabase2 class
        bot_db = MagicMock()
        ...
        # Mock the PyMasterBotDatabase2 instance creation
        PyMasterBotDatabase2 = MagicMock(return_value=bot_db)
        ...
        bot.send_message.assert_called_with(123, "You have been set as the first admin.")
