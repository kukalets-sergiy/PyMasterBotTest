...
from Handlers.csv_importer import (
    add_lessons_csv,
    add_test_tasks_csv,
    add_code_tasks_csv,
    add_ai_test_tasks_csv,
    add_ai_code_tasks_csv,
    add_csv_to_database,
    add_ai_lessons_csv,
)
...
# # Змінити рядок з'єднання на асинхронний
# DB_CONNECTION_STRING = f"postgresql+asyncpg://{DB_USER}:{DB_PASSWORD}@{DB_HOST}:{DB_PORT}/{DB_NAME}"
#
# # Створити асинхронний двіжок та сесію
# async_engine = create_async_engine(DB_CONNECTION_STRING, echo=True)
...
class PyMasterBotDatabaseFactory(DatabaseFactory):
    async def create_database(self):
        return PyMasterBotDatabase2()


class AbstractDatabase(ABC):
    @abstractmethod
    async def add_lesson(self, lesson_id, topic, item, description, text, status):
        pass
# class AbstractDatabase(ABC):
#     @abstractmethod
#     async def add_lesson(self, lesson_id, topic, item, description, text, status):
#         pass
    ...
    @abstractmethod
    async def add_test_task(self, task_id, topic, question, var1, var2, var3, right_answer, level_relation):
        pass

    # @abstractmethod
    # async def add_ai_test_task(self, task_id, topic, question, var1, var2, var3, right_answer, level_relation):
    #     pass

    @abstractmethod
    async def add_code_task(
        self,
        code_task_id,
        topic,
        question,
    ...
    @abstractmethod
    async def add_level(self, level_id, level_name):
        pass

    @abstractmethod
    async def add_lesson_progress(self, user_id, lesson_id):
        pass
    ...
    @abstractmethod
    async def check_lesson_exists(self, lesson_id):
        pass
    ...
    @abstractmethod
    async def check_levels_exist(self):
        pass

    @abstractmethod
    async def check_status_premium(self, user_id):
        pass
    ...
    @abstractmethod
    async def delete_test_task(self, test_task_id):
        pass

    @abstractmethod
    async def delete_code_task(self, code_task_id):
        pass

    @abstractmethod
    async def delete_level(self, level_name):
        pass
    ...
    @abstractmethod
    async def get_lessons_by_status(self, status):
        pass

    @abstractmethod
    async def get_lessons_by_topic(self, topic):
        pass

    @abstractmethod
    async def get_lessons_by_item(self, item):
        pass

    @abstractmethod
    async def get_lessons_topics(self):
        pass

    @abstractmethod
    async def get_lessons_items(self, topic):
        pass

    @abstractmethod
    async def get_random_lessons_items(self):
        pass

    @abstractmethod
    async def get_lesson_last_id(self):
        pass

    @abstractmethod
    async def get_test_task_by_question(self, question):
        pass

    @abstractmethod
    async def get_test_task_last_id(self):
        pass

    @abstractmethod
    async def get_test_task_by_id(self, test_task_id):
        pass

    @abstractmethod
    async def get_code_task_by_question(self, question):
        pass

    @abstractmethod
    async def get_code_task_last_id(self):
        pass

    @abstractmethod
    async def get_code_task_by_id(self, code_task_id):
        pass

    @abstractmethod
    async def get_level_by_name(self, level_name):
        pass
    ...
    @abstractmethod
    async def get_level_last_id(self):
        pass
    ...
    @abstractmethod
    async def get_comment_by_text(self, comment):
        pass

    @abstractmethod
    async def get_comment_last_id(self):
        pass

    @abstractmethod
    async def get_own_comments_by_name(self, user_name):
        pass

    @abstractmethod
    async def get_total_lessons_count(self):
        pass
    ...
    @abstractmethod
    async def get_users_by_score(self, score):
        pass
    ...
    @abstractmethod
    async def get_test_tasks_topics_by_level(self, level):
        pass

    @abstractmethod
    async def get_code_tasks_topics_by_level(self, level):
        pass
    ...
    @abstractmethod
    async def update_user_paid_until(self, user_id, paid_until):
        pass

    @abstractmethod
    async def update_user_scores(self, score_threshold, increment):
        pass
    ...
    @abstractmethod
    async def add_csv_to_database(self, csv_filename):
        pass

    @abstractmethod
    async def add_lessons_csv(self, csv_filename):
        pass

    @abstractmethod
    async def add_test_tasks_csv(self, csv_filename):
        pass

    @abstractmethod
    async def add_ai_test_tasks_csv(self, csv_filename):
        pass

    @abstractmethod
    async def add_ai_code_tasks_csv(self, csv_filename):
        pass

    @abstractmethod
    async def add_ai_lessons_csv(self, csv_filename):
        pass

    @abstractmethod
    async def add_code_tasks_csv(self, csv_filename):
        pass
    ...
    @abstractmethod
    async def get_test_tasks_by_level(self, level):
        pass

    @abstractmethod
    async def get_test_tasks_by_level_and_topic(self, level_name, topic):
        pass

    @abstractmethod
    async def get_code_tasks_by_level(self, level):
        pass

    @abstractmethod
    async def get_code_tasks_by_level_and_topic(self, level_name, topic):
        pass

    @abstractmethod
    async def get_user_progress_testing_level(self, user_id, level_name):
        pass

    @abstractmethod
    async def get_uncompleted_test_tasks_by_level(self, user_id, level_name):
        pass

    @abstractmethod
    async def get_uncompleted_code_tasks_by_level(self, user_id, level_name):
        pass

    @abstractmethod
    async def add_task_to_progress_testing(self, user_id, task_id, level_name):
        pass

    @abstractmethod
    async def add_lesson_to_progress_lesson(self, user_id, lesson_id):
        pass

    @abstractmethod
    async def check_this_level_task_exists(self, level_name):
        pass

    @abstractmethod
    async def add_code_task_to_progress_coding(self, user_id, code_task_id, level_name):
        pass

    @abstractmethod
    async def check_this_level_code_task_exists(self, level_name):
        pass

    @abstractmethod
    async def get_level_count(self, level_name):
        pass

    @abstractmethod
    async def is_task_in_progress_testing(self, user_id, task_id, level_name):
        pass

    @abstractmethod
    async def is_code_task_in_progress_coding(self, user_id, code_task_id, level_name):
        pass
    ...
    @abstractmethod
    async def check_coding_rank(self, user_id):
        pass

    @abstractmethod
    async def check_lessons_rank(self, user_id):
        pass

    @abstractmethod
    async def top_users_by_score(self, top_number):
        pass

    @abstractmethod
    async def rank_user_score(self, user_id):
        pass

    @abstractmethod
    async def check_code_rank(self, user_id):
        pass

    @abstractmethod
    async def get_code_level_count(self, level_name):
        pass

    @abstractmethod
    async def get_user_progress_coding_level(self, user_id, level_name):
        pass


class PyMasterBotDatabase2(AbstractDatabase, ABC):
    def __init__(self):
        # Creating an async engine for PostgreSQL database connection.
        self.engine = create_async_engine(
            f"postgresql+asyncpg://{DB_USER}:{DB_PASSWORD}@{DB_HOST}:{DB_PORT}/{DB_NAME}")
        # Creating an async session maker with future mode enabled.
        # This session maker will be used to create async sessions for interacting with the database.
...
#         self.session = self.Session()
    ...
    async def add_test_task(self, task_id, topic, question, var1, var2, var3, right_answer, level_relation):
        async with self.async_session() as session:
            ...
            await session.add(new_test_task)
            await session.commit()
    ...
    async def add_code_task(
        ...
        async with self.async_session() as session:
            ...
            await session.add(new_code_task)
            await session.commit()

    async def add_comment(self, comment_id, name, comment):
        async with self.async_session() as session:
            new_comment = Comment(id=comment_id, name=name, comment_from_user=comment)
            await session.add(new_comment)
            await session.commit()

    async def add_level(self, level_id, level_name):
        async with self.async_session() as session:
            new_level = Level(id=level_id, level_name=level_name)
            await session.add(new_level)
            await session.commit()
    ...
    async def get_comment_by_text(self, comment_text):
    ...
    async def get_test_tasks_by_level_and_topic(self, level_name, topic):
        test_tasks_by_level_and_topic = (
            self.session.query(TestTask).filter(TestTask.level_relation == level_name, TestTask.topic == topic).all()
        )
        return test_tasks_by_level_and_topic

    async def get_code_tasks_by_level_and_topic(self, level_name, topic):
        code_tasks_by_level_and_topic = (
            self.session.query(CodeTask).filter(CodeTask.level_relation == level_name, CodeTask.topic == topic).all()
        )
        return code_tasks_by_level_and_topic

    async def get_user_progress_testing_level(self, user_id, level_name):
        user_progress_testing_level = (
            self.session.query(User).filter(func.json_array_length(User.progress_testing[f"{level_name}"]) > 0).all()
        )

        return user_progress_testing_level

    async def get_user_progress_coding_level(self, user_id, level_name):
        user_progress_coding_level = (
            self.session.query(User).filter(func.json_array_length(User.progress_coding[f"{level_name}"]) > 0).all()
        )
    ...
    async def get_level_count(self, level_name):
        ...
        values = (
            self.session.query(User.progress_testing[level_name])
            .filter(User.progress_testing[level_name].isnot(None))
            .first()
        )
    ...
    async def get_code_level_count(self, level_name):
        # Зробити запит для отримання значень для заданого рівня
        values = (
            self.session.query(User.progress_coding[level_name])
            .filter(User.progress_coding[level_name].isnot(None))
            .first()
        )
